...
def create_parser():
    ...
    # parser.add_argument('--path_T', '-t',  default='results/celeba/HSIC/0_0/20230618_172529/Classifier_0.8958.pth', help='')      star
    return parser
...
def parse_arguments(parser):
    ...
    # config.target_model_config["weights"] = args.path_T       star
